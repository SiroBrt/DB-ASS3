...
create index idx_places on Editions(PUB_PLACE);
create index idx_pub on Editions(PUBLISHER);

--

create cluster cond(CONDITION CHAR(1));
CREATE TABLE Copies(
SIGNATURE          CHAR(5),
...
)cluster cond(CONDITION);
create index idx_cond on cluster cond;
